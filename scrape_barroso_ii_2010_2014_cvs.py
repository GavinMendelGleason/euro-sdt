...
Requires commission_barroso_ii_2010_2014.csv to exist (run scrape_commission.py first).
Outputs: commission_barroso_ii_2010_2014_cv_data.csv  and enriches commission_barroso_ii_2010_2014.csv
"""
...
df_cv.to_csv("commission_barroso_ii_2010_2014_cv_data.csv", index=False)
print("Saved commission_barroso_ii_2010_2014_cv_data.csv")
...
try:
    ...
    print(
        f"Matched {matched} / {len(df_merged)} commissioners from commission_barroso_ii_2010_2014.csv"
    )

    df_merged.to_csv("commission_barroso_ii_2010_2014.csv", index=False)
    print("Saved enriched commission_barroso_ii_2010_2014.csv")
except FileNotFoundError:
    print("commission_barroso_ii_2010_2014.csv not found — run scrape_commission.py first.")
