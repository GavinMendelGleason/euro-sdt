...
Requires commission_i_2019_2024.csv to exist (run scrape_commission.py first).
Outputs: commission_i_cv_data.csv  and enriches commission_i_2019_2024.csv
"""
...
df_commission = pd.read_csv('data/commissions/commission_i_2019_2024.csv')
...
df_cv.to_csv("commission_i_cv_data.csv", index=False)
print("Saved commission_i_cv_data.csv")

# Merge with commission list if it exists
try:
    df_commission = pd.read_csv("commission_i_2019_2024.csv")
    ...
    print(
        f"Matched {matched} / {len(df_merged)} commissioners from commission_i_2019_2024.csv"
    )

    df_merged.to_csv("commission_i_2019_2024.csv", index=False)
    print("Saved enriched commission_i_2019_2024.csv")
except FileNotFoundError:
    print("commission_i_2019_2024.csv not found — run scrape_commission.py first.")
