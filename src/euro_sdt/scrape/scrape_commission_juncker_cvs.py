...
Requires commission_juncker_2014_2019.csv to exist (run scrape_commission.py first).
Outputs: commission_juncker_cv_data.csv  and enriches commission_juncker_2014_2019.csv
"""
...
df_commission = pd.read_csv('data/commissions/commission_juncker_2014_2019.csv')
...
df_cv.to_csv("commission_juncker_cv_data.csv", index=False)
print("Saved commission_juncker_cv_data.csv")

# Merge with commission list if it exists
try:
    df_commission = pd.read_csv("commission_juncker_2014_2019.csv")
    ...
    print(
        f"Matched {matched} / {len(df_merged)} commissioners from commission_juncker_2014_2019.csv"
    )

    df_merged.to_csv("commission_juncker_2014_2019.csv", index=False)
    print("Saved enriched commission_juncker_2014_2019.csv")
except FileNotFoundError:
    print("commission_juncker_2014_2019.csv not found — run scrape_commission.py first.")
