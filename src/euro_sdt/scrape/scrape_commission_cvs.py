...
Requires commission_2024_2029.csv to exist (run scrape_commission.py first).
Outputs: commission_cv_data.csv  and enriches commission_2024_2029.csv
"""
...
df_commission = pd.read_csv('data/commissions/commission_2024_2029.csv')
...
df_cv.to_csv("commission_cv_data.csv", index=False)
print("Saved commission_cv_data.csv")

# Merge with commission list if it exists
try:
    df_commission = pd.read_csv("commission_2024_2029.csv")
    ...
    print(
        f"Matched {matched} / {len(df_merged)} commissioners from commission_2024_2029.csv"
    )

    df_merged.to_csv("commission_2024_2029.csv", index=False)
    print("Saved enriched commission_2024_2029.csv")
except FileNotFoundError:
    print("commission_2024_2029.csv not found — run scrape_commission.py first.")
