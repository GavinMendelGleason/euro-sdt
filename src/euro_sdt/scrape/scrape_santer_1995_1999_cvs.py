...
Requires commission_santer_1995_1999.csv to exist (run scrape_commission.py first).
Outputs: commission_santer_1995_1999_cv_data.csv  and enriches commission_santer_1995_1999.csv
"""
...
df_commission = pd.read_csv('data/commissions/commission_santer_1995_1999.csv')
...
df_cv.to_csv("commission_santer_1995_1999_cv_data.csv", index=False)
print("Saved commission_santer_1995_1999_cv_data.csv")

# Merge with commission list if it exists
try:
    df_commission = pd.read_csv("commission_santer_1995_1999.csv")
    ...
    print(
        f"Matched {matched} / {len(df_merged)} commissioners from commission_santer_1995_1999.csv"
    )

    df_merged.to_csv("commission_santer_1995_1999.csv", index=False)
    print("Saved enriched commission_santer_1995_1999.csv")
except FileNotFoundError:
    print("commission_santer_1995_1999.csv not found — run scrape_commission.py first.")
