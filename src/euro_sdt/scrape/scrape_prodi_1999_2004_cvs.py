...
Requires commission_prodi_1999_2004.csv to exist (run scrape_commission.py first).
Outputs: commission_prodi_1999_2004_cv_data.csv  and enriches commission_prodi_1999_2004.csv
"""
...
df_commission = pd.read_csv('data/commissions/commission_prodi_1999_2004.csv')
...
df_cv.to_csv("commission_prodi_1999_2004_cv_data.csv", index=False)
print("Saved commission_prodi_1999_2004_cv_data.csv")

# Merge with commission list if it exists
try:
    df_commission = pd.read_csv("commission_prodi_1999_2004.csv")
    ...
    print(
        f"Matched {matched} / {len(df_merged)} commissioners from commission_prodi_1999_2004.csv"
    )

    df_merged.to_csv("commission_prodi_1999_2004.csv", index=False)
    print("Saved enriched commission_prodi_1999_2004.csv")
except FileNotFoundError:
    print("commission_prodi_1999_2004.csv not found — run scrape_commission.py first.")
